...
namespace DownTest
{
    public partial class MainForm : Form
    {
        ...
        private void Start_newTask(string httpurl, string saverootpath)
        {
            ...
            var usercontrol = new PerTaskPanel();
            usercontrol.deleteTask += Usercontrol_deleteTask;
            usercontrol.logTask += Usercontrol_logTask;
        ...
        private void SaveLog(string msg)
        {
            ...
            var logfile = Func.getFileName(rootpath, "log_{0}.txt");
            Func.WriteFile(logfile, msg);
        }
